...
namespace HZSoft.Application.Web.Areas.WeChatManage.Controllers
{
    ...
    public class WeiXinHomeController : BaseWxUserController
    {
        ...
        public ActionResult Index(string urlstr)
        {
            ...
            {
                urlstr = Url.Action("NearbyMap", "Nearby");
            }
            //2.定位
        ...
        public ActionResult GetMap(string currentLon = "", string currentLat = "")
        {
        ...
        public ActionResult GetWxPic(string media_id, string callback, string folder)
        {
            ...
            string dir = String.Format("/Resource/DocumentFile/{0}/{1}/", folder, uploadDate);
